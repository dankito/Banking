...
open class AccountingEntryMapper {
    ...
    companion object {
        ...
        private val log = LoggerFactory.getLogger(AccountingEntryMapper::class.java)
    }


    open fun mapAccountingEntries(result: GVRKUms): List<AccountingEntry> {
    ...
    protected open fun mapAccountingEntry(buchung: GVRKUms.UmsLine): AccountingEntry {
