package net.dankito.banking.javafx.dialogs.accountdetails.controls
...
class AccountDetailsField(private val fieldName: String, private val fieldValue: String) : View() {
